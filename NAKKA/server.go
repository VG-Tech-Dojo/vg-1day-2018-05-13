...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/NAKKA/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/NAKKA/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/NAKKA/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	yoichiBot := bot.NewYoichiBot(s.poster.In)
	s.bots = append(s.bots, yoichiBot)
