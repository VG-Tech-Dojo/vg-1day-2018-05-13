...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/rikiya/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/rikiya/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-05-13/rikiya/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// mission3
	placeBot := bot.NewPlaceBot(s.poster.In)
	s.bots = append(s.bots, placeBot)
